...
interface LoginPageProps {
  ...
  onLogin?: (role: 'guest' | 'startup' | 'admin') => void;
}
...
const LoginPage: React.FC<LoginPageProps> = ({ onNavigate, onLogin }) => {
  ...
  return (
    <StyledWrapper>
      <div className="auth-hero">
        <div className="brand">
          <img src={new URL('../../public/assets/logo_jeb.png', import.meta.url).href} alt="JEB" />
          <h1>Bienvenue</h1>
          <p>Connectez-vous à la plateforme JEB</p>
        </div>
        <form className="form glass" onSubmit={handleSignIn}>
  ...
  <p className="p">Don&apos;t have an account? <span className="span" onClick={() => onNavigate?.('signup')}>Sign Up</span>
...
C318.115,0,375.068,22.126,419.404,58.936z" />
            ...
            Google 
          </button><button className="btn apple" type="button">
...
const StyledWrapper = styled.div`
  .auth-hero {
    ...
    background: radial-gradient(1200px 600px at -10% -10%, rgba(99,102,241,0.15), transparent),
                radial-gradient(1200px 600px at 110% -10%, rgba(14,165,233,0.15), transparent),
                radial-gradient(1200px 600px at 50% 110%, rgba(16,185,129,0.12), transparent);
    display: grid;
    place-items: center;
